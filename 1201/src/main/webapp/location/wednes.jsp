...
<body>
	...
	<div id="text">
		...
		>&ensp;|&ensp;<a id="links" href="/location/wednes.jsp" style="color:#660066">수요미식회</a>&ensp;|</span>
	</div>
	...
	<script type="text/javascript" src="${path}/resources/js/wednesMap.js"></script>
</body>
</html>
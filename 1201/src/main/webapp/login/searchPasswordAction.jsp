...
<%
	...
	String result = userDAO.returnPassword(email, name, id);
	if(result == null){
		out.println(result);
	...
	for(int i =0; i<10; i++){
		...
		newPw += Integer.toString(temp);
	}
	userDAO.userPasswordUdapte(newPw, id);
	
	String host = "http://localhost:8181/login/";
	String from = "202044003@itc.ac.kr";
	String to = userDAO.getEamil(id);
	String subject = "맛집을 사이트 임시 비밀번호 입니다.";
	String content = "회원님에 임시 비밀번호는 " + newPw + "입니다." + 
...
%>
	...
	<td>
		...
		<div class="alert alert-success mt-4" role="alert">
			회원님에 이메일로 임시비밀번호를 보냈습니다. 회원가입시 입력했던 이메일에 들어사셔 확인해주세요.
		</div>
	</section>
	</td>
	</tr>
